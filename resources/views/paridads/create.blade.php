...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Crear Tipo de Cambio') }}</div>
                ...
                <div class="card-body">                    
                    ...
                    <form method="POST" action="{{ route('paridads.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="paridad" type="number"
                                    ...
                                    value="{{ old('paridad') }}" required autocomplete="paridad" autofocus step="0.01" placeholder="1">
