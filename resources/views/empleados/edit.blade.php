                ...
                <div class="card-body">  
                   ...
                   <div class="row">
                        ...
                        <form method="POST" action="{{ route('empleados.update',$empleado->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('salario') is-invalid @enderror" name="user_id"
                                        required>
                                        ...
                                        <option {{ $user->id==$empleado->user_id ? 'selected' : '' }} value="{{ $user->id }}"> {{ $user->name }}</option>
                       ...
                       <div class="col-md-4">
                            ...
                            <img src="{{ asset('storage/img/'.$empleado->foto) }}" alt="" width="100%" height="50%">
