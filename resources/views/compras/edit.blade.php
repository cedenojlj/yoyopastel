...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">{{ __('Actualizar Proveedor') }}</div>
                    ...
                    <form method="POST" action="{{ route('proveedors.update',$proveedor->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" 
                                    ...
                                    value="{{ $proveedor->nombre }}" required autocomplete="nombre" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rif" type="text" class="form-control @error('rif') is-invalid @enderror"
                                    name="rif" value="{{ $proveedor->rif }}" required autocomplete="rif" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="direccion" type="text"
                                    ...
                                    value="{{ $proveedor->direccion }}" required autocomplete="direccion" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text"
                                    ...
                                    value="{{ $proveedor->telefono }}" required autocomplete="telefono" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ $proveedor->email }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row mb-0 justify-content-center">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a name="" id="" class="btn btn-primary" href="{{ route('proveedors.index') }}"
